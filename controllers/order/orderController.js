...
class OrderController {
    ...
    async initPayment(req, res) {
        ...
        const discount = req.session.cart.discount ? req.session.cart.discount : 0 
        const totalPrice = req.session.cart.totalPrice + req.session.cart.shipping.cost - discount
